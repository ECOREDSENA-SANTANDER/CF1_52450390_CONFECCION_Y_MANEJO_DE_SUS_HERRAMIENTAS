    ...
    .row.justify-content-center.align-items-center(data-aos="zoom-in")
      .col-lg-7.mb-4
        LineaTiempoD.color-acento-botones.activo
          ...
          p(numero="2" titulo="Tijeras de papel") Las tijeras de papel, como su nombre lo indica, son para cortar papel y estas sí pueden ser usadas en otro tipo de materiales tales como el plástico o el cartón.
          p(numero="3" titulo="Alfileres") Los alfileres es recomendable que sean de cabeza grande y puntiagudos, si los alfileres tienen la punta chata o partida, pueden romper los tejidos de la tela en la cual los estemos pinchando.
          p(numero="4" titulo="Tiza para confección") La tiza es usada para marcar los moldes y señas en la tela.
          p(numero="5" titulo="Pinzas para enhebrado") Las pinzas para enhebrado son usadas principalmente para pasar el hilo por los lupers  en el momento de enhebrar las máquinas especialmente la máquina fileteadora y/o recubridora.
          ...
          p(numero="7" titulo="Pulidora") Con la pulidora, además de cortar las hebras de hilo sobrantes en el proceso de confección, se puede pulir la prenda cuando ya está terminada.
